...
> - **Dogmas a Aplicar:** Specific architectural rules (e.g., 'Zero Numerical Hallucination', 'Dependency Inversion', use of Pydantic/Decimal) that GCA must strictly enforce today.
> - **Passo 1 (Atómico):** The exact, single first instruction GCA must execute when the session begins.
