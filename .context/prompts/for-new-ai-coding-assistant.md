...
- Ensure state mutations in LangGraph are handled immutably and accurately.
- Refuse to write prompts that ask the LLM to calculate math; instead, generate the Python tool that does the math.
